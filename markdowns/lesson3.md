...
Para se utilizada pelo programa, a variável precisa ser declarada. Para se declarar uma variável é necessário dar  um nome (as regras de formação do nome encontra-se descrito no item [Identificadores](#identificadores) e associá-la a um tipo de dado, conforme exemplo abaixo: 
```
Exemplo:
